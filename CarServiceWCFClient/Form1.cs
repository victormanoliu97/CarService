    ...
    public partial class Form1 : Form
    {
        ...
        private void clientsFoundListBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (sessionData.clientRepository.GetAutosOfClient(obtainedClient) != null)
                    {
                        ...
                        List<Automobil> clientAutos =
                            new List<Automobil>(sessionData.clientRepository.GetAutosOfClient(obtainedClient));
        ...
        private void getOrdersForAutoButton_Click(object sender, EventArgs e)
        {
            ...
            sessionData.selectedAuto = AutoMapper.FromModelToEntity((AutoModel)clientAutosListBox.SelectedItem);
            if (sessionData.autoRepository.GetOrdersForCar(sessionData.selectedAuto) != null)
            {
                List<Comanda> foundOrders =
                    new List<Comanda>(sessionData.autoRepository.GetOrdersForCar(sessionData.selectedAuto));
